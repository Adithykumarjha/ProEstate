...
export const signin = async (req,res,next)=>{
  ...
  try {
    ...
    //below we are creating json token using json webtoken then save as cookie 
    const token = jwt.sign({id:validUser._id},process.env.JWT_SECRET)
    const {password:pass,...rest} = validUser._doc;  // it returns the userdata except password
