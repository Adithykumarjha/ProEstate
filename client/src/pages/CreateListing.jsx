...
function CreateListing() {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
      <h1 className='tect-3xl font-semibold text-center my-7 '>Create a Listing</h1>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row  gap-4' action="">
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex gap-4'>
            ...
            <button type='button'
            disabled={uploading} className='p-3 text-green-700 border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80 ' onClick={handleImageSubmit}>{uploading ? 'Uploading..': 'Upload'}</button>
          </div>
        </div>
